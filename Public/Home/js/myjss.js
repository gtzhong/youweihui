    ...
    function l() {
        $(".pl-ctlist").eq(0).addClass("pl-cto"),
            ...
            $(".pl-ctlist").click(function(e) {
                e.stopPropagation()
                var _xx = $(this).parents(".catid").find(".pl-ctpl:visible").length
                var t = $(this).index() - 1
                var _than = this
                $(this).addClass("pl-cto").siblings().removeClass("pl-cto")
                $(this).parents(".ilx-schlist-wrap").find(".pl-ctpl:visible").fadeOut("slow", function() {
                    if (_xx < 1) {
                        $(this).parents(".catid").animate({
                            height: '35px'
                        }, "slow", function() {
                            $(_than).parents(".catid").height("140px")
                        })
                    }
                })
                $(this).parents(".catid").height("140px").find(".pl-ctpl").eq(t).show()
            }),
            $("body").click(function() {
                $(".ilx-schlist").hide(),
