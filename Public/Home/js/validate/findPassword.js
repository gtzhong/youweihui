...
front_validate = {
    ...
    findPassword: function() {
        jQuery("#modiform").validate({
            errorClass: "zhmm_main1_nrk_bottom1_right",
            ...
            errorPlacement: function(error, element) {
                ...
                // } else {
                //     element.closest(".zhmm_main1_nrk_bottom1").append(error)
                // }
                element.closest(".zhmm_main1_nrk_bottom1").append(error)
                // element.closest(".zhmm_main1_nrk_bottom1").find(".zhmm_main1_nrk_bottom1_right").remove();
            },
            rules: {
                mobile: {
                    required: true,
